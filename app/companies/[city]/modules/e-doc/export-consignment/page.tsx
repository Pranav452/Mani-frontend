...
export default function ExportConsignmentPage() {
  ...
  const handleNavigation = (menuName: string) => {
    if (menuName === "Export Master") {
      // Navigate to export master page
      router.push(`/companies/${encodeURIComponent(city)}/modules/e-doc/export-consignment/export-master`);
    } else if (menuName === "Search") {
      // Navigate to search page
      router.push(`/companies/${encodeURIComponent(city)}/modules/e-doc/export-consignment/search`);
    } else if (menuName === "Add New Job") {
      // Navigate to add new job page or stay on current page
      // For now, we'll stay on the current consignment page
